  ...
  return (
    ...
    >
      <motion.div className="container home_container">
        ...
        <motion.h1 variants={itemVariants}>Rajendra Yadav</motion.h1>
        ...
        <motion.div className="home_social" variants={itemVariants}>
          <a href="https://www.linkedin.com/in/rajendrayadav02/">
            <BsLinkedin />
          </a>
          <a href="https://github.com/rajendra-yadav02">
            <BsGithub />
          </a>
          <a href="">
            <BsMedium />
