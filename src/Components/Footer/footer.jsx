...
const Footer = () => {
  ...
  return (
    ...
    >
      <motion.a href="#home" className='footer_logo' variants={linkVariants}>Rajendra Yadav</motion.a>
      ...
      <motion.div className="footer_social" variants={footerVariants}>
        <motion.a href="https://www.linkedin.com/in/rajendrayadav02/" variants={linkVariants}><BsLinkedin /></motion.a>
        <motion.a href="https://github.com/rajendra-yadav02" variants={linkVariants}><BsGithub /></motion.a>
        <motion.a href="" variants={linkVariants}><BsMedium /></motion.a>
      </motion.div>

      <motion.div className="footer_copyright" variants={footerVariants}>
        <small>&copy; Rajendra Yadav. All Rights Reserved.</small>
      </motion.div>
    </motion.footer>
  );
}
